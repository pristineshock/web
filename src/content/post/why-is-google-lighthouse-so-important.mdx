---
publishDate: 2022-10-18T09:30:00Z
title: "Why is Google Lighthouse so important?"
...
<Image src={import("~/assets/images/blog/google-lighthouse-google.png")} alt="Score of Google" />
_Score of Google.com_

---

Lighthouse audits your pages using a straightforward 1-100 rating scale. You could think,*"Okay, so the better the page is, the
higher the scores are."*That is accurate.
...
- _Perfect_ scores account for only 2% of websites
...
<Image src={import("~/assets/images/blog/google-lighthouse-facebook.png")} alt="Score of Facebook" />
_Score of Facebook.com_
...
<Image src={import("~/assets/images/blog/google-lighthouse-twitter.png")} alt="Metrics of Twitter" />
_Metrics of Twitter.com_
...
<Image src={import("~/assets/images/blog/google-lighthouse-etsy.png")} alt="PageDetox of Etsy.com" />
_PageDetox of Etsy.com_
